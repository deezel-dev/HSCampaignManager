<div ng-controller="mainCtrl">
   ...
   <div ng-show="showSuggestion">
      <?php require $_SERVER['DOCUMENT_ROOT'] . "/flix/flix_main_suggestion_bar.html" ?>
   </div>
   ...
   <div ng-show="1">
    ...
    <!--
    <div ng-init="showMovie=false" ng-show="showMovie" data-ng-controller="flixMiniMovieViewCtrl">
        <?php //require $_SERVER['DOCUMENT_ROOT'] . "/flix/flix_main_mini_movie.html" ?>
    </div>
    -->
</div>